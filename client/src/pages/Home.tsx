      ...
      <section className="py-20 bg-[oklch(0.95_0.018_80)]" aria-labelledby="menu-preview-heading">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { title: "The Grandma Slice", desc: "16\" square, 12 slices. Thin-crust with bubbling mozzarella and plum marinara. The original.", tag: "SIGNATURE", price: "$36.20", img: "https://images.getbento.com/accounts/fd7c1089a4a4619f426a2c9d673b0ae5/media/images/292661U1A6384.jpg?w=600&fit=crop&auto=compress,format" },
              { title: "Chicken Parmigiana", desc: "Crispy breaded chicken cutlet, homemade tomato sauce, melted mozzarella. A Long Island staple.", tag: "BESTSELLER", price: "$31.14", img: "https://images.getbento.com/accounts/fd7c1089a4a4619f426a2c9d673b0ae5/media/images/83464parm-chicken.jpg?w=600&fit=crop&auto=compress,format" },
              { title: "Pazzo Deep Dish", desc: "16\" round deep dish with fresh mozzarella, marinara, homemade sausage, black olives & roasted peppers.", tag: "FAN FAVORITE", price: "$33.40", img: "https://images.getbento.com/accounts/fd7c1089a4a4619f426a2c9d673b0ae5/media/images/12732Umbertos-Pepperoni-3.jpg?w=600&fit=crop&auto=compress,format" },
              { title: "Spaghetti Pescatore", desc: "Mussels, clams, shrimp in a light marinara sauce over perfectly cooked spaghetti.", tag: "SEAFOOD", price: "$24.95", img: "https://images.getbento.com/accounts/fd7c1089a4a4619f426a2c9d673b0ae5/media/images/97139spaghetti_vongole.png?w=600&fit=max&auto=compress,format" },
              { title: "Homemade Lasagna", desc: "Ricotta, homemade mozzarella, meatballs & sausage in our famous tomato sauce.", tag: "CLASSIC", price: "$19.70", img: "https://images.getbento.com/accounts/fd7c1089a4a4619f426a2c9d673b0ae5/media/images/326236A4A5195.jpg?w=600&fit=crop&auto=compress,format" },
              { title: "Rigatoni Umberto", desc: "Rigatoni with calamari, shrimp, and fresh tomato sauce. Named after the founder himself.", tag: "HOUSE SPECIAL", price: "$22.95", img: "https://images.getbento.com/accounts/fd7c1089a4a4619f426a2c9d673b0ae5/media/images/36275067_6A4A2737.jpg?w=600&fit=crop&auto=compress,format" },
            ].map((item, i) => (
